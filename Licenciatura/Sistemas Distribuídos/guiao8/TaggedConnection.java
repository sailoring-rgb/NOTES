...
public class TaggedConnection implements AutoCloseable {
    ...
    public Frame receive() throws IOException{
        ...
        try{
            ...
            data = new byte[n];
            this.is.readFully(data); // tenta ler o máximo que está associado ao sistema operativo do socket e minimiza o consumo de bytes a serem lidos (é uma otimização)
        } finally {
            rlock.unlock():
        }
